...
async function flagQuestion() {
  ...
  const data = await $fetch("/api/questions/flag", {
    method: "POST",
    body: {
      questionIndex: questionIndex.value,
    },
  });
  console.log("Flagging question:", data);
  toast.add({
    title: "Question flagged!",
    description: `Flagged questions will be reviewed by the admin, thanks for your contribution.`,
    icon: "uil:robot",
  });
